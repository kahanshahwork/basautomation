...
@parser_bp.route("/")
def index():
    """Serve the built frontend if present; else the old landing page."""
    dist_index = os.path.join(APP_ROOT, "frontend", "dist", "index.html")
    if os.path.exists(dist_index):
        return send_from_directory(os.path.join(APP_ROOT, "frontend", "dist"), "index.html")
